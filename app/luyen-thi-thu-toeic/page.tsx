      ...
      <section className="max-w-6xl mx-auto px-4 pt-10 md:pt-14 pb-10">
        <div className="bg-[#109FDE] rounded-2xl px-6 md:px-10 py-10 md:py-12 text-center text-white shadow-sm">
          ...
          <p className="mt-5 max-w-3xl mx-auto text-sm md:text-base text-white/90 leading-relaxed">
            Cùng có kiến thức và tối đa hóa điểm số TOEIC với các bài thi thử online bám sát format mới nhất
            từ ETS. Luyện tập không giới hạn với các bộ đề Listening &amp; Reading đầy đủ, có đáp án và giải thích
            chi tiết. Hệ thống chấm điểm tự động giúp bạn theo dõi tiến độ và làm quen với áp lực thời gian như
            thi thật.
          </p>
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5 max-w-3xl mx-auto">
            ...
            <div className="bg-[#0D86BE] border border-white/10 rounded-xl px-6 py-4 flex items-center gap-3 text-white/95">
              ...
              <span className="font-bold">Giao diện thân thiện, dễ sử dụng</span>
            </div>
            <div className="bg-[#0D86BE] border border-white/10 rounded-xl px-6 py-4 flex items-center gap-3 text-white/95">
              <span className="inline-flex w-10 h-10 items-center justify-center rounded bg-white/10 border border-white/10">
                📄
              </span>
              <span className="font-bold">Đề thi có độ khó tương đương thi thật</span>
            </div>
            <div className="bg-[#0D86BE] border border-white/10 rounded-xl px-6 py-4 flex items-center gap-3 text-white/95">
              <span className="inline-flex w-10 h-10 items-center justify-center rounded bg-white/10 border border-white/10">
                ✉️
      ...
      <section className="max-w-6xl mx-auto px-4 pb-14">
        ...
        <div className="mt-8 flex justify-center">
          <div className="w-full max-w-3xl bg-white border border-[#BCE8FF] rounded-xl px-5 md:px-8 py-4 text-gray-600 text-xs md:text-sm italic">
            <span>
              Lưu ý: Đây là một bài thi thử được biên soạn nhằm mục đích luyện tập và đánh giá năng lực cá nhân.
              Nội dung và cấu trúc đề thi có thể không hoàn toàn giống với đề thi thật. Chúng tôi không chịu
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Pill active={activeTag === 'Listening'} onClick={() => setActiveTag('Listening')}>
            Listening
          </Pill>
          <Pill active={activeTag === 'Reading'} onClick={() => setActiveTag('Reading')}>
            Reading
          </Pill>
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex items-center gap-3">
                  ...
                  <div className="text-sm text-gray-600">
                    <span className="font-bold text-gray-800">{e.rating.toFixed(1)}</span>{' '}
